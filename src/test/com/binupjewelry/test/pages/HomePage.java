...
public class HomePage extends BasePage {
    ...
    @FindBy(how= How.ID, using="sp_basket_info_count")
    public WebElement lnkCartItemCount;
    ...
    public int getCartItemCount() {
        HelperUtil.waitForElementToBeVisible(lnkCartItemCount);
        int itemCount=Integer.parseInt(lnkCartItemCount.getText());
        return itemCount;
    }
}
